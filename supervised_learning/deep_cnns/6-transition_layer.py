#!/usr/bin/env python3
"""A transition layer is used in DenseNet
architectures to control the complexity of
the model and to reduce the number of
feature maps and spatial dimensions between
dense blocks."""
...
def transition_layer(X, nb_filters, compression):
    """Function that buids a transition layer
        ...
        Code should implement compression
        as used in DenseNet-C
