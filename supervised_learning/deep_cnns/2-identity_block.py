#!/usr/bin/env python3
"""defines the identity_block architecture.
It's designed to preserve the original input
features while allowing the network to learn
residual functions."""
...
def identity_block(A_prev, filters):
    """Function that builds an identity block
        ...
        filters is a tuple of list containing
        F11, F3, F12
