...
class GaussianProcess:
    ...
    def __init__(self, X_init, Y_init, l=1, sigma_f=1):
        ...
        representing the outputs of the
        black-box function for each input in
        X_init
    ...
    def kernel(self, X1, X2):
        ...
        matrix between to matrices:
            X1 is a numpy.ndarray of shape
            (m, 1)
            X2 is a numpy.ndarray of shape
            (n, 1)
            the kernel should use Radial Basis
            Function(RBF)
        Returns: the covariance kernel matrix
        as a numpy.ndarray of
        shape (m, n)"""
