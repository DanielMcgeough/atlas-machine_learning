#!/usr/bin/env python3
"""sparse meaning an encoder
Rather than regularizing the weights,
sparse autoencoders penalize activations
within a layer to encourage the network
to rely only on a small number of activated
neurons for any given observation.
This forces the network to selectively
activate regions depending on the input
data, limiting its capacity to memorize
the input data but not limiting its
capability to extract features."""
