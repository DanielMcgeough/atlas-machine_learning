#!/usr/bin/env python3
"""Module for The Viterbi Algorithm
someone made a spelling mistake.
Like the forward algorithm it helps
you find the most probable sequence of
hidden states given the output. most likely
path and maximization differntiate it.
